...
# ---------------------------------------------------------------------------
# AavaPlatformEmbedder is NOT present
# ---------------------------------------------------------------------------

class TestAavaEmbedderNotExported:
    def test_aava_embedder_not_in_module(self) -> None:
        """AavaPlatformEmbedder is an internal Aava service class and must NOT
        exist in the public trelix embedder module."""
        import trelix.embedder.base as mod
        assert not hasattr(mod, "AavaPlatformEmbedder"), (
            "AavaPlatformEmbedder must be removed from the trelix public API"
        )
