...
FEATURE_FLOW_CASES: list[tuple[str, str]] = [
    ...
    ("how are query plan models and intent types defined","src/trelix/retrieval/planner/models.py"),
...
TRELIX_SELF_CASES: list[tuple[str, str]] = (
    ...
    + FEATURE_FLOW_CASES
    + BLAST_RADIUS_CASES
    + CONFIG_OVERVIEW_CASES
)

assert len(TRELIX_SELF_CASES) == 50, (
    f"Expected 50 eval cases, got {len(TRELIX_SELF_CASES)}"
)
