# Trelix v2.11.1 — Installation Guide

This guide covers every installation scenario for Trelix v2.11.1, from a quick
...
trelix --version   # should print 2.11.1
```
...
[GitHub Releases](https://github.com/sairam0424/trelix/releases/tag/v2.11.1)
page for each platform. No Python or pip required.

### macOS ARM64 (Apple Silicon)

```bash
curl -L https://github.com/sairam0424/trelix/releases/download/v2.11.1/trelix-macos-arm64 \
...
```bash
curl -L https://github.com/sairam0424/trelix/releases/download/v2.11.1/trelix-linux-x64 \
     -o /usr/local/bin/trelix
chmod +x /usr/local/bin/trelix
trelix --version
```
...
```bash
curl -L https://github.com/sairam0424/trelix/releases/download/v2.11.1/trelix-linux-arm64 \
     -o /usr/local/bin/trelix
chmod +x /usr/local/bin/trelix
trelix --version
```
...
docker run --rm \
  -v "$(pwd):/repo" \
  ghcr.io/sairam0424/trelix:2.11.1 \
  index /repo
```
...
```bash
# Print version (must show 2.11.1)
trelix --version
