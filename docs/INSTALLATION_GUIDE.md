# Trelix v2.11.0 — Installation Guide

This guide covers every installation scenario for Trelix v2.11.0, from a quick
...
trelix --version   # should print 2.11.0
```
...
[GitHub Releases](https://github.com/sairam0424/trelix/releases/tag/v2.11.0)
page for each platform. No Python or pip required.

### macOS ARM64 (Apple Silicon)

```bash
curl -L https://github.com/sairam0424/trelix/releases/download/v2.11.0/trelix-macos-arm64 \
...
```bash
curl -L https://github.com/sairam0424/trelix/releases/download/v2.11.0/trelix-linux-x64 \
     -o /usr/local/bin/trelix
chmod +x /usr/local/bin/trelix
trelix --version
```
...
```bash
curl -L https://github.com/sairam0424/trelix/releases/download/v2.11.0/trelix-linux-arm64 \
     -o /usr/local/bin/trelix
chmod +x /usr/local/bin/trelix
trelix --version
```
...
docker run --rm \
  -v "$(pwd):/repo" \
  ghcr.io/sairam0424/trelix:2.11.0 \
  index /repo
```
...
```bash
# Print version (must show 2.11.0)
trelix --version
