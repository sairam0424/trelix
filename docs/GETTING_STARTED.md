...
Once registered, Claude can call `trelix_search`, `trelix_ask`, and `trelix_graph` tools directly against your indexed repos. The v2.4.0 MCP server supports pagination for large result sets.
