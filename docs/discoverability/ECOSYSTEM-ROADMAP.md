...
- ✅ flare_max_retries backward-compat rename shipped (v2.4.0) — TRELIX_RETRIEVAL_FLARE_MAX_RETRIES (new) + TRELIX_RETRIEVAL_FLARE_MAX_ITER (deprecated v2.4.0, removed v3.3.0)
