...
_STOP_WORDS = frozenset({
    "a", "an", "the", "is", "it", "in", "of", "to", "do", "be", "as", "at",
    "by", "or", "and", "for", "on", "are", "was", "has", "had", "can",
    "not", "but", "this", "that", "with", "from", "what", "how", "why", "who",
    "when", "where", "which", "show", "me", "tell", "give", "get", "all",
    "about", "does", "did", "will", "would", "could", "should", "have", "been",
    "into", "than", "then", "them", "they", "their", "there", "use", "used",
    "using", "any", "our", "each", "more", "also", "just", "some", "such",
    "like", "over", "after", "before", "between", "out", "make", "know",
    "find", "list", "return", "returns", "code", "file", "function", "method",
    "class", "type", "value", "call", "calls", "new", "my", "you", "your",
    "so", "no", "if", "am", "we", "he", "she", "his", "her",
})
